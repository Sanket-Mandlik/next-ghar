...
const ServiceHero = () => {
  ...
  return (
    ...
    >
      {/* Left Section */}
      <div className="lg:w-3/10 h-full flex flex-col items-center justify-between lg:py-8  lg:px-8  px-6 py-6 relative overflow-hidden">
        <p className="absolute top-5 left-6 pr-6 text-sm text-gold/80 z-10">
...
>
  <FaFacebook className="text-soft-white text-2xl" />
      ...
      <div className="lg:w-7/10 flex flex-col justify-center bg-warm-white rounded-l-3xl relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-8 gap-y-15 relative z-10 lg:p-8 p-6 " >
