          ...
          >
            ...
            <div className="w-full lg:w-1/2 bg-soft-white px-6 py-4 mb-2 rounded-b-3xl lg:rounded-r-3xl lg:rounded-bl-none relative flex flex-col justify-center  ">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 lg:space-y-10">
                ...
                <button
                  type="submit"
                  className="w-full lg:w-1/2 px-4 lg:px-6 bg-soft-white shadow-xl shadow-warm-beige/50 bg-gradient-to-br from-gold via-dark-brown to-dark-brown text-soft-white py-3 lg:py-4 rounded-xl font-semibold hover:opacity-90 transition-all min-h-[48px]"
                >
                  Submit
                </button>
              </form>
