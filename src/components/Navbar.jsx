...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-2 left-1/2 transform -translate-x-1/2 z-50 w-full pointer-events-none">
    <nav className="pointer-events-auto mx-auto lg:w-[90%] w-[95%] py-2.5 px-6 bg-soft-white shadow-lg shadow-warm-beige/50 rounded-2xl border-t-4 border-gold flex justify-between items-center">
